...
class GeminiProvider(LLMProvider):
    ...
    def complete(self, messages, system=None, temperature=0.7, max_tokens=1000):
        ...
        # Convert role format: openai "assistant" -> gemini "model"
        history = []
        for m in messages[:-1]:
...
def create_provider(
    ...
    model: Optional[str] = None,
    openai_client=None,          # backwards-compat: accept existing openai client
